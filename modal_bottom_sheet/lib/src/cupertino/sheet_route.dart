...
const Curve _kCupertinoSheetCurve = Cubic(0.420, 0.000, 0.580, 1.000);
...
class CupertinoSheetRoute<T> extends SheetRoute<T> {
  CupertinoSheetRoute({
    ...
    this.topRadius = _kCupertinoSheetTopRadius
            ...
            animationCurve: Cubic(0.17, 0.04, 0.03, 0.94),
            stops: stops,
  ...
  Widget buildTransitions(
    ...
    // var curve = secondaryAnimation.status == AnimationStatus.reverse ? Curves.elasticIn : Curves.elasticOut ;
